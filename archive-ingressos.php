...
$title   = $cpt_obj ? $cpt_obj->label : 'Ingressos';
?>
...
<main class="site-main">
  <div class="container">
    ...
    <?php if (have_posts()) : ?>
      <section class="ec-archive__grid ec-archive__grid--ingressos" aria-label="<?php echo esc_attr($title); ?>">
        <?php while (have_posts()) : the_post(); ?>
          <?php get_template_part('template-parts/components/card-ingresso', null, ['post' => get_post()]); ?>
        <?php endwhile; ?>
      </section>
