...
$archive_url = get_post_type_archive_link('convidados');
?>
...
<main class="site-main">
  <div class="container">
    ...
    <nav class="ec-breadcrumb" aria-label="Breadcrumb">
      ...
      <a href="<?php echo esc_url($archive_url); ?>">Convidados</a>
      <span aria-hidden="true">›</span>
    ...
    <?php while (have_posts()) : the_post(); ?>
      <article class="ec-single">
        ...
        <footer class="ec-single__footer">
          <a class="ec-button" href="<?php echo esc_url($archive_url); ?>">&laquo; Voltar para convidados</a>
        </footer>
